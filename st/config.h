 ...
 */
static char *font = "BerkeleyMono Nerd Font:size=13:antialias=true:autohint=true";
...
/*
 * Terminal colors (16 first used in escape sequence, 2 last for custom
 * cursor color). This is the "Darkmatter" scheme, ported from
 * ~/dotfiles/wezterm/.wezterm.lua -- edit the hex values below (and keep
 * that file in sync) to change it.
 */
static const char *colorname[] = {
	...
	[256] = "#ffffff", /* cursor color (cursor_bg) */
	"#121113",         /* reverse cursor color (cursor_fg) */
};
